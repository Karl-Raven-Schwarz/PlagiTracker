<template>
  ...
  <form @submit.prevent="handleSubmit" class="space-y-4">
    <div>
      <label for="name" class="block mb-1 font-medium dark:text-white">Exercise Name</label>
      <input
        type="text"
        id="name"
    ...
    <div>
      <label for="description" class="block mb-1 font-medium dark:text-white">Description</label>
      <textarea
        id="description"
    ...
    <div class="flex items-center">
      <input
        ...
        class="mr-2"
      />
      <label for="haveBody" class="font-medium dark:text-white">Have Body</label>
    </div>
  </form>
</template>
