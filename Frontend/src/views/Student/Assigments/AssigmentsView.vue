...
<template>
  <DefaultLayout>
    ...
    <div v-if="!courseExists" class="flex flex-col justify-center items-center w-full bg-gray-50 dark:bg-boxdark-2 inset-0 z-10 p-4 sm:p-8 md:p-12 lg:p-16">
      <h3 class="font-semibold text-red-600 dark:text-red-400 text-2xl">{{ errorMessage }}</h3>
